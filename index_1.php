...
<?php
	...
	echo '<td><a href=#>首頁</a></td>';
	echo '<td><a href=login.html>登陸</a></td>';
	echo '<td><a href=reg.html>註冊</a></td>';
	echo '</table>';
...
<input id="nickname" name="nickname" type="text" /><span>(必須填寫，不超過16個字)</span>
</p>
<p>
